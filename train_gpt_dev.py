...
class Hyperparameters:
    ...
    # Runtime / systems knobs.
    compile_model = bool(int(os.environ.get("COMPILE_MODEL", "1")))
    compile_muon = bool(int(os.environ.get("COMPILE_MUON", "1")))
    float32_matmul_precision = os.environ.get("FLOAT32_MATMUL_PRECISION", "high")
    ...
    # SOTA-lite regularization knobs.
    # Decoupled weight decay, inspired by leaderboard configs.
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in params:
                ...
                # Applied with the current scheduled learning rate.
...
def main() -> None:
    ...
    # H100: enable TF32 matmul path for float32 ops when available.
    ...
    # Ne considère le mode distribué que s'il y a réellement plus d'un process.
    ...
    log0(
        ...
        f"float32_matmul_precision:{args.float32_matmul_precision} "
    ...
    log0(
        f"weight_decay embed_wd:{args.embed_wd} "
